...
def parse_args():
    ...
    p.add_argument("--force-retokenize", action="store_true", help="Ép chạy lại tokenize dù đã có input_ids_qwen")
...
def main():
    ...
    if do_tok:
        ...
        print("[SKIP] train.jsonl đã có input_ids_qwen — bỏ qua tokenize")
